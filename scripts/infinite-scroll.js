 ...
 */
 ...
 (function(scope) {
  ...
  // Số mục cần khởi tạo ngoài chế độ xem hiện tại theo hướng cuộn.
  var RUNWAY_ITEMS = 50;
  
  // Number of items to instantiate beyond current view in the opposite direction.
  // Số mục cần khởi tạo ngoài chế độ xem hiện tại theo hướng ngược lại.
  var RUNWAY_ITEMS_OPPOSITE = 20;
  
  // The number of pixels of additional length to allow scrolling to.
  var SCROLL_RUNWAY = 20;
